            ...
            if (UnityEngine.SceneManagement.SceneManager.GetActiveScene().name.Equals("Game"))
            {
                if (!SGameMng.I.PlayerSc._bPlayerDie)
                {
                    ...
                    if (SGameMng.I.PlayerType.Equals(PLAYERTYPE.WOLF))
                        SGameMng.I.PlayerSc.Wolf_AuraAnime.SetBool("Idle", true);
                }
            }
            else if (UnityEngine.SceneManagement.SceneManager.GetActiveScene().name.Equals("Lobby"))
            {
                Mng.I.CharSc.PlayerAnime.SetBool("isIdle", true);
                Mng.I.CharSc.PlayerAnime.SetBool("isRWalking", false);
                Mng.I.CharSc.PlayerAnime.SetBool("isLWalking", false);
            }
            ...
            if (SnapsToFinger)
            {
                ...
                if (UnityEngine.SceneManagement.SceneManager.GetActiveScene().name.Equals("Game"))
                {
                    ...
                    if (SGameMng.I.PlayerType.Equals(PLAYERTYPE.WOLF))
                    {
                        ...
                        {
                            SGameMng.I.PlayerSc.Wolf_AuraAnime.SetBool("Idle", false);
